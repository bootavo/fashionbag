...
public class TermsConditions extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String customHtml = "<body style='padding: 12px;'>\n" +
                ...
                "\n" +
                "\t<p align='justify'>\n" +
                "<p>Las presentes Condiciones Generales, regulan el uso del portal de Internet www.fashionbagperu.com (en adelante “Portal”), de propiedad de CORPORACION LOS SAUCES SAC con RUC: 20565868557 con nombre comercial <strong>FASHION BAG</strong> (en adelante “FASION BAG”), una sociedad constituida y regida bajo la legislación vigente de la República del Perú.</p>\n" +
                "\n" +
                "      <p>La utilización de los servicios dispuestos en el Portal le atribuye al visitante o internauta la condición de Usuario del Portal (en adelante, “Usuario”) e implica su aceptación plena y sin reservas de todas y cada una de las disposiciones incluidas en estas Condiciones Generales en la versión publicada por FASHION BAG, en el momento mismo en que el Usuario acceda al Portal y/o utiliza los servicios dispuestos en el mismo.</p>\n" +
                "\n" +
                ...
                "\n" +
                "      <p>FASHION BAG se reserva el derecho de modificar los términos de las presentes Condiciones Generales, así como de las Condiciones Particulares. En tal caso, FASHION BAG avisará con suficiente antelación a los Usuarios registrados sobre cualquier modificación que sobre las Condiciones Generales y/o Condiciones Particulares se produzca y procederá a publicarlas en su nueva versión, sustituyendo de forma automática a las anteriores. El acceso al Portal o utilización posterior del Servicio por parte de los Usuarios tras una modificación de las Condiciones Generales y/o Condiciones Particulares supondrá la aceptación inequívoca de las mismas.</p>\n" +
                "\n" +
                "      <p>Al acceder y utilizar el sitio web de FASHION NAG usted expresamente reconoce y acepta los siguientes Términos y Condiciones. Si no acepta estos Términos y Condiciones, por favor no utilice el sitio web de FASHION BAG ni descargue material alguno.</p>\n" +
                "\n" +
                "      <p>FASION BAG  se reserva el derecho de modificar o suspender, temporal o permanentemente, en cualquier momento y sin previo aviso, el Sitio web o materiales publicados en los mismos (todo o parte de ellos) así como los productos descritos en ellos. Sin que ello genere derecho a reclamo o indemnización alguna a favor del usuario.</p>\n" +
                "\n" +
                "      <p>Del mismo modo, FASHION BAG se reserva el derecho de modificar estos Términos y Condiciones, así como el diseño, la presentación o configuración, los requisitos de registro o uso en el Sitio web, en cualquier momento y sin previo aviso ni comunicación alguna, sin que ello genere derecho a reclamo o indemnización alguna a favor del usuario. Convenimos que es su responsabilidad vigilar los cambios y actualizaciones de forma periódica.</p>\n" +
                "\n" +
                "      <p><strong>Propiedad Intelectual:</strong></p>\n" +
                "\n" +
                "      <p>FASHION BAG es el titular de todos los derechos legítimos sobre el Sitio web y los materiales que en ellos se encuentren. Asimismo, FASHION BAG es licenciatario de todos los nombres comerciales, marcas comerciales, marcas de servicios, marcas de productos, logotipos, nombres de dominio y otras características distintivas de las marcas contenidas en ellos. Se prohíbe cualquier copia, reproducción, modificación, publicación, carga, envío, transmisión o distribución en modo alguno, salvo indicación expresa en contrario. FASHION BAG no concede derecho expreso alguno ni implícito sobre las patentes, derechos de autor, marcas comerciales o información de secretos comerciales.</p>\n" +
                "\n" +
                "      <ol>\n" +
                "        <li>\n" +
                "          <h3>SEGURIDAD Y PRIVACIDAD</h3>\n" +
                "\n" +
                "          <p>La información que usted envíe a FASHION BAG a través de formularios para completar datos en el Sitio web se regirá de conformidad con el siguiente texto. En ese sentido, como usuario de este sitio web, le informamos sobre el uso que le damos a los datos que registre en el mismo, a fin que pueda decidir si quiere ingresar sus datos o no.</p>\n" +
                "\n" +
                "          <p>FASHION BAG ofrece a los Usuarios del Servicio la garantía de privacidad y seguridad en las transacciones, la confidencialidad de los datos facilitados y la encriptación de los mismos mediante el sistema de Secure Socket Layer (SSL) de 256 bits. Todos los procesos de pago de transacciones a los Usuarios serán procesados mediante los terminales de las entidades financieras con plena garantía de seguridad y confidencialidad. </p>\n" +
                "\n" +
                "          <ol>\n" +
                "            <li>\n" +
                "              <p>PROTECCIÓN DE DATOS PERSONALES</p>\n" +
                "\n" +
                "              <p>Los datos recogidos a través de este sitio web serán objeto de tratamiento automatizado por parte de FASHION BAG o de terceros e incorporados a los correspondientes bancos de datos o ficheros de los que FASHION BAG es titular y responsable.</p>\n" +
                "\n" +
                "              <p>A través del procedimiento de Registro de Usuarios en el Portal, éstos proporcionan a FASHION BAG datos de carácter personal tales como a:</p>\n" +
                "\n" +
                "              <ul>\n" +
                ...
                "              </ul>\n" +
                "\n" +
                "              <p>Esta enumeración es meramente enunciativa más no limitativa, por lo que todos los demás datos de carácter personal que brinde el Usuario a FASHION BAG, se sujetarán también a la presente Política.</p>\n" +
                "\n" +
                "              <p>FASHION BAG podría llegar a solicitar al Usuario otros datos personales, según la justificación del caso.</p>\n" +
                "\n" +
                ...
                "\n" +
                "              <p>Vínculos electrónicos de terceros: La página web de FASHION BAG puede contener vínculos electrónicos, ligas o “Hot Links”, hacia otras páginas web de Internet que son patrocinadas, manejadas y/u operadas por proveedores externos y otras organizaciones en estrecha relación con FASHION BAG. Sin embargo, aun cuando el proveedor este afiliado a FASHION BAG o viceversa, FASHION BAG no tiene ningún tipo de control sobre estas páginas web vinculadas.</p>\n" +
                "\n" +
                "            </li>\n" +
                "          </ol>\n" +
                "        </li>\n" +
                ...
                "\n" +
                "          <ul>\n" +
                "            <li>Compra en Oficina de FASHION BAG mediante efectivo o pago por POS</li>\n" +
                "            <li>Compra por deposito en cuenta Bancaria de FASHION BAG</li>\n" +
                "            <li>Pago por WEB o APP mediante una pasarela de pagos con tarjetas diversas</li>\n" +
                "          </ul>\n" +
                "\n" +
                "          <p>FASHION BAG informa al Comprador que, una vez realizada la adquisición o compra de un productos, por la naturaleza del mismo, no habrá derecho a retracto, pero si respetamos el proceso de devoluciones descrito en el capítulo 4.</p>\n" +
                "\n" +
                "          <ol>\n" +
                "            <li>\n" +
                "              <p>Adjudicación y Confirmación de la compra.</p>\n" +
                "\n" +
                "              <p>Realizada la adquisición, FASHION  BAG enviará un correo electrónico de confirmación a la dirección facilitada por el Comprador en su formulario de registro.</p>\n" +
                "\n" +
                "              <p>Esta comunicación servirá de prueba de la transacción entre FASHION BAG  y Comprador. El Comprador no podrá desistir o revocar su aceptación.</p>\n" +
                "            </li>\n" +
                "\n" +
                "            <li>\n" +
                "              <p>Precio de los productos para el Comprador.</p>\n" +
                "\n" +
                "              <p>Precio de los productos son públicos en la WEB y los usuarios tendrán acceso a todos estos cuando ingresen al portal con su Usuario y Clave, así mismo cada mes se publican nuevos productos que mediante Emails y redes sociales oficiales de FASHION BAG son publicados</p>\n" +
                "            </li>\n" +
                "          </ol>\n" +
                "        </li>\n" +
                "\n" +
                "        <li>\n" +
                "          <h3>CONSIDERACIONES PARA LA INCORPORACIÓN</h3>\n" +
                "\n" +
                "          <p>Si usted está interesada en incorporarse como Emprendedora Independiente, revise detenidamente la siguiente información y por favor ingrese a la sección Comienza tu negocio en la página web www.fashionbagperu.com</p>\n" +
                "        </li>\n" +
                "\n" +
                "        <li>\n" +
                "          <h3>POLITICAS DE CAMBIOS Y DEVOLUCIONES</h3>\n" +
                "\n" +
                "          <p>Fashion Bag solo acepta cambios y/o devoluciones por problemas de falla de fábrica. Este proceso solo se podrá realizar durante los 5 días siguientes a la compra de los productos, para ello, se deberá entregar el producto en sus condiciones originales (incluyendo bolsa plástica original, etiquetas, producto sin uso y comprobante de compra) a fin de reembolsarle su dinero o le sirva de crédito para sus siguientes compras.&nbsp;</p>\n" +
                "\n" +
                "          <p>Si se encuentra fuera de Lima. Solo deje su producto en cualquier agencia de OLVA Courier, pagando el envío a la oficina FASHION BAG PERU en Lima / San Isidro. Las coordinaciones de envío se deben realizar con el Equipo de Asesoras en horario de oficina. La devolución vía correo postal, dependiendo del servicio, puede tomar entre 7 a 10 días laborables en llegar a nuestras oficinas y otros 2 días en ser evaluado. Luego de aprobado el reembolso, considerar el tiempo de 15 días laborables para que se complete totalmente la devolución.</p>\n" +
                "        </li>\n" +
                "\n" +
                "        <li>\n" +
                "          <h3>SATISFACCIÓN GARANTIZADA</h3>\n" +
                "\n" +
                "          <p>Con el fin de ofrecer el mejor servicio a sus clientes, Fashion Bag se compromete en ofrecer la satisfacción garantizada de sus compras.</p>\n" +
                "\n" +
