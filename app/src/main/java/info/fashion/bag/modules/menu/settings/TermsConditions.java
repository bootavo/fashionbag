...
public class TermsConditions extends BaseActivity{
    ...
    public void init(){
        ...
        String customHtml = "<body style='padding: 12px;'>\n" +
                ...
                "\n" +
                "\t<p align='justify'>\n" +
                "<p>Las presentes Condiciones Generales, regulan el uso de la aplicación Tarjetic (en adelante “Tarjetic”), de propiedad de la Empresa Tarjetic con RUC: 20565868557 con nombre comercial <strong>Tarjetic</strong> (en adelante “FASION BAG”), una sociedad constituida y regida bajo la legislación vigente de la República del Perú.</p>\n" +
                "\n" +
                ...
                "\n" +
                "      <p>Al acceder y utilizar el sitio web de FASHION NAG usted expresamente reconoce y acepta los siguientes Términos y Condiciones. Si no acepta estos Términos y Condiciones, por favor no utilice el sitio web de Tarjetic ni descargue material alguno.</p>\n" +
                "\n" +
